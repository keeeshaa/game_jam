...
class drop(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\main\images\rain.png')# coin image
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale(pygame.image.load(r'C:\Users\Admin\Desktop\pp2\main\images\pixel_sprite_rain.png'),(200,200))# image of the player's sprite
        self.rect = self.image.get_rect()
